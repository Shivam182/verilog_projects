...
module Ahb_slave(
	...
	output reg valid, 
	output reg [31:0] Haddr1, Haddr2, Hwdata1, Hwdata2, // The Haddr signal holds the address of transaction, while Haddr1 and Haddr2 are used for pipeline management
